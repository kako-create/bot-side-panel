...
const VARIABLE_PATHS = withCommonRoots([
  ...
  'variablesToAssignment.variable',
  'variablesToAssignment.name',
  'variablesToAssignment.key',
  'variablesToAssignment.variableName',
...
const CONDITION_PATHS = withCommonRoots([
  ...
  'variables.operator',
  'variables.rule',
  'variablesToAssignment.condition',
  'variablesToAssignment.operator',
  'variablesToAssignment.rule',
...
const VALUE_PATHS = withCommonRoots([
  ...
  'variables.text',
  'variables.content',
  'variablesToAssignment.value',
  'variablesToAssignment.text',
  'variablesToAssignment.content',
